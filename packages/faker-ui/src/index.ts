...
import App from './App'
import { type Logger, initLogger } from '@baicie/logger'
import { extend, safeJsonParse, wsPath } from '@baicie/faker-shared'
...
declare const __FAKER_UI_OPTIONS__: string

const wsPort = Number(__FAKER_WS_PORT__)
const loogerOptions: Logger = safeJsonParse<Logger>(
